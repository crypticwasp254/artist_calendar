...
// export const watchIntersect = () => {
//     const touchin = (entries) => {
//         entries.forEach(entry => {
//             if (entry.isIntersecting) {
//                 console.log(entry)
//                 let fix_hour = entry.target.querySelector('.timeofday')
//                 if (fix_hour.classList[1] === 'fix') {
//                     fix_hour.style = `
//                         color:chartreuse;
//                         position:fixed;
//                         left:125px;
...
//     let tod = document.querySelectorAll('.goal')
//     let root_node = document.querySelector('.goals')
//     let observer_options = {
//         root: null, threshold: 0.1,
//         rootMargin: '0px 0px -500px  0px'
//     }
//     const observer = new IntersectionObserver(touchin, observer_options)
//     tod.forEach(gol => {
//         observer.observe(gol)
//     })
//     // })
// }
